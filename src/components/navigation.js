  ...
  return (
    `<nav class="main-navigation">
      <div class="main-navigation__items">
        <a href="${FilterType.ALL}" class="main-navigation__item main-navigation__item--active">All movies</a>
        <a href="${FilterType.WATCHLIST}" class="main-navigation__item">Watchlist <span class="main-navigation__item-count">${watchlist}</span></a>
        <a href="${FilterType.HISTORY}" class="main-navigation__item">History <span class="main-navigation__item-count">${history}</span></a>
        <a href="${FilterType.FAVORITES}" class="main-navigation__item">Favorites <span class="main-navigation__item-count">${favorites}</span></a>
      </div>
...
export default class Navigation extends AbstractComponent {
  ...
  setFilterTypeChangeHandler(handler) {
    ...
    parentEl.addEventListener(`click`, (evt) => {
      ...
      const filterType = evt.target.attributes.href.textContent;
